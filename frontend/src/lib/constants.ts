...
export const API_PATHS = {
  ...
  ADMIN_ACCESS_REQUESTS: `${P}/me/admin-access-requests`,
  ADMIN_USERS: `${P}/admin/users`,
  adminUser: (id: string) => `${P}/admin/users/${id}`,
  ADMIN_ACCESS_REQUEST_QUEUE: `${P}/admin/admin-access-requests`,
  adminAccessRequest: (id: string) => `${P}/admin/admin-access-requests/${id}`,
